...
platform5.w=80000;
platform5.h=900;
platform5.color=`yellow`;
platform5.world=level;
platform5.y=8000;

platform7.w=200;
platform7.h=24;
platform7.color=`yellow`;
...
function menu() {
        ...
        ctx.fillStyle = "black";
        ctx.font = "48px Arial";
        ctx.fillText("Bloxy adventure", c.width/2 - 100, c.height/2 - 50);
        ...
        ctx.fillStyle = "white";
        ctx.font = "20px Arial";
        ctx.fillText("Start Game", c.width/2 - 40, c.height/2 + 75);
